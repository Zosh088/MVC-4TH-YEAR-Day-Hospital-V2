...
namespace Surgeon__Day_Hospital_.Migrations
{
    ...
    [Migration("20241003190617_PrescriptionStatus")]
    partial class PrescriptionStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Surgeon__Day_Hospital_.Models.Patient_Current_Medication", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Patient_Current_Medications");
                });
            ...
            modelBuilder.Entity("Surgeon__Day_Hospital_.Models.PurchaseManager", b =>
                {
            ...
            modelBuilder.Entity("Surgeon__Day_Hospital_.Models.Day_Hospital_Records", b =>
                {
                    b.HasOne("Surgeon__Day_Hospital_.Models.Address_Book", "Address")
                        .WithMany()
            ...
            modelBuilder.Entity("Surgeon__Day_Hospital_.Models.MedOrder_Record", b =>
                {
                    b.HasOne("Surgeon__Day_Hospital_.Models.PurchaseManager", "PurchaseManagers")
                        .WithMany()
            ...
            modelBuilder.Entity("Surgeon__Day_Hospital_.Models.Patient_Current_Medication", b =>
                {
                    b.HasOne("Surgeon__Day_Hospital_.Models.Pharmacy_Medication", "Medication")
                        .WithMany()
